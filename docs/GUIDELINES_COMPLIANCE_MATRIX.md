...
| 2 150-line rule | COMPLIANT | ADR-005; Phase 4D1A–D1D audits; permanent regression test | Zero `src/` or `tests/` Python violations across 92 files | REF-001 | 187-test acceptance and independent count audit |
