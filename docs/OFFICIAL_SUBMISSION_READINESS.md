...
1. Finish the public-safe CLI/manual acceptance and retain this ledger.
2. Implement the role-legal Live GUI and artifact-backed Replay view (`GUI-001`).
3. Produce safe reproducible research figures and the academic analysis (`RES-001`, `VIS-001`).
