...
EXPECTED = {
    ...
    "league": {
        ...
        "KIT_SORTED_FIRST_POLICE_ODD_V1", "LocalhostSeriesRequest",
        "LocalhostSeriesResult", "TeamDeclarationIdentity",
        ...
        "run_localhost_series", "series_reference_terms", "series_token_totals",
